...
define('scopedcss/cssRule',[],function() {
...
define('scopedcss/styleSheet',['require','./cssRule'],function(require) {
...
define('scopedcss/index',['require','./styleSheet'],function(require) {
...
define('scopedcss', ['scopedcss/index'], function (main) { return main; });
  return require("scopedcss");
}));
